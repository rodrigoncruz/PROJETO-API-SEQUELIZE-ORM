...
class FuncionarioController {
    ...
    static async atualizaFuncionario(req, res) {
        const { id } = req.params
        const atualizarFuncionario = req.body
        try {
            await database.Funcionarios.update(atualizarFuncionario, { where: { id: Number(id) }});
